...
public enum StartGameError: Error, LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case let .invalidPlayerCount(count):
        ...
        case let .invalidPlayerName(name):
