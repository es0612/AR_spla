...
extension TestData {
    ...
    public static func randomPlayer() -> Player {
        let colors = PlayerColor.allCases
        let randomColor = colors.randomElement()!
        
        return PlayerBuilder()
            .withName("Random Player \(Int.random(in: 1...1000))")
    ...
    public static func randomInkSpot(ownerId: PlayerId, color: PlayerColor) -> InkSpot {
    ...
    public static func randomGameSession() -> GameSession {
